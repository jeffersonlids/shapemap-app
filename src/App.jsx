...
const TR = {
  pt: {
    ...
    alunos: "Clientes",
    pesquisar_aluno: "Pesquisar cliente...",
    novo_aluno: "Novo Cliente",
    masculino: "Masculino",
    feminino: "Feminino",
    genero: "Gênero",
    telefone: "Telefone",
    data_nascimento: "Data de Nascimento",
    cadastrar_aluno: "Cadastrar Cliente",
    nome_completo: "Nome Completo",
    nenhum_aluno: "Nenhum cliente encontrado",
    cadastre_primeiro_aluno: "Cadastre seu primeiro cliente para começar.",
    excluir_aluno: "Excluir Cliente",
    ...
    todos_alunos: "Todos os Clientes",
    nenhum_aluno_cadastrado: "Nenhum cliente cadastrado ainda",
    clique_novo_aluno: 'Clique em "Novo Cliente" acima para começar.',
    nenhum_aluno_busca: "Nenhum cliente encontrado para sua busca.",
    este_mes: "Este mês",
    excluir: "Excluir",
    cadastrar: "Cadastrar",
  ...
  en: {
    ...
    avaliador: "Trainer",
    alunos: "Clients",
    pesquisar_aluno: "Search client...",
    novo_aluno: "New Client",
    masculino: "Male",
    feminino: "Female",
    genero: "Gender",
    telefone: "Phone",
    data_nascimento: "Date of Birth",
    cadastrar_aluno: "Register Client",
    nome_completo: "Full Name",
    nenhum_aluno: "No client found",
    cadastre_primeiro_aluno: "Register your first client to start.",
    excluir_aluno: "Delete Client",
    ...
    bem_vindo: "Welcome",
    todos_alunos: "All Clients",
    nenhum_aluno_cadastrado: "No clients registered yet",
    clique_novo_aluno: 'Click on "New Client" above to start.',
    nenhum_aluno_busca: "No clients found for your search.",
    este_mes: "This month",
    excluir: "Delete",
    cadastrar: "Register",
  ...
  es: {
    ...
    alunos: "Clientes",
    pesquisar_aluno: "Buscar cliente...",
    novo_aluno: "Nuevo Cliente",
    masculino: "Masculino",
    feminino: "Femenino",
    genero: "Género",
    telefone: "Teléfono",
    data_nascimento: "Fecha de Nacimiento",
    cadastrar_aluno: "Registrar Cliente",
    nome_completo: "Nombre Completo",
    nenhum_aluno: "Ningún cliente encontrado",
    cadastre_primeiro_aluno: "Registra tu primer cliente para empezar.",
    excluir_aluno: "Eliminar Cliente",
    ...
    todos_alunos: "Todos los Clientes",
    nenhum_aluno_cadastrado: "Ningún cliente registrado aún",
    clique_novo_aluno: 'Haz clic en "Nuevo Cliente" arriba para empezar.',
    nenhum_aluno_busca: "Ningún cliente encontrado para tu búsqueda.",
    este_mes: "Este mes",
    excluir: "Eliminar",
    cadastrar: "Registrar",
    ...
    evolucao_massa_gorda: "Evolución de la Masa Grasa",
...
function compressImage(file, callback) {
  ...
  reader.onload = function(e) {
    ...
    img.onload = function() {
      ...
      var compressedDataUrl = canvas.toDataURL('image/jpeg', 0.55);
